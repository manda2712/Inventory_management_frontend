<template>
    <div class="home-view d-flex flex-column align-items-center text-white">
        <div class="text-center mb-4 welcome-text">
            ...
            <p class="lead mb-4">
                A powerful platform to efficiently manage your inventory and streamline operations.
            </p>
        </div>
        <div class="auth-container bg-light p-5 rounded shadow">
